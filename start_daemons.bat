...
echo [7/9] Pulse (Kart daemon)...
start "Willow-Pulse" /MIN python core/pulse.py --daemon

REM Pigeon + OCR Consumer are spawned by server.py (with stale-kill protection).
REM Do NOT launch them here — duplicates exhaust Postgres connections.
echo [8/9] Pigeon Daemon... SKIPPED (server.py owns this)
echo [9/9] OCR Consumer...  SKIPPED (server.py owns this)
