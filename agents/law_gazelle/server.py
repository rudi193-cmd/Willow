"""
Law Gazelle — SAFE Consumer Interface Server
=============================================
Law Gazelle agent FastAPI server at port 2123.
Proxies chat to Willow's agent API, journals all exchanges.
Normal users interact with Willow's system through Law Gazelle — never directly.
"""
...
AGENT_PORT = 2123
AGENT_NODE = "law_gazelle"
USERNAME = "Sweet-Pea-Rudi19"

NEST_PATH = Path(r"C:\Users\Sean\Willow\Nest\law_gazelle")

app = FastAPI(
    title="Law Gazelle",
    description="SAFE Law Gazelle Agent — tracks legal documents, citations, and regulatory references",
)
