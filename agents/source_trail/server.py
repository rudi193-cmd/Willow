"""
Source Trail — SAFE Consumer Interface Server
=============================================
Source Trail agent FastAPI server at port 2126.
Proxies chat to Willow's agent API, journals all exchanges.
Normal users interact with Willow's system through Source Trail — never directly.
"""
...
AGENT_PORT = 2126
AGENT_NODE = "source_trail"
USERNAME = "Sweet-Pea-Rudi19"

NEST_PATH = Path(r"C:\Users\Sean\Willow\Nest\source_trail")

app = FastAPI(
    title="Source Trail",
    description="SAFE Source Trail Agent — tracks provenance, citations, and the origin of data and claims",
)
