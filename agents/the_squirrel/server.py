"""
The Squirrel — SAFE Consumer Interface Server
=============================================
The Squirrel agent FastAPI server at port 2127.
Proxies chat to Willow's agent API, journals all exchanges.
Normal users interact with Willow's system through The Squirrel — never directly.
"""
...
AGENT_PORT = 2127
AGENT_NODE = "the_squirrel"
USERNAME = "Sweet-Pea-Rudi19"

NEST_PATH = Path(r"C:\Users\Sean\Willow\Nest\the_squirrel")

app = FastAPI(
    title="The Squirrel",
    description="SAFE The Squirrel Agent — collects, stores, and retrieves saved resources, links, and stashed items",
)
