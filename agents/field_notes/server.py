"""
Field Notes — SAFE Consumer Interface Server
=============================================
Field Notes agent FastAPI server at port 2122.
Proxies chat to Willow's agent API, journals all exchanges.
Normal users interact with Willow's system through Field Notes — never directly.
"""
...
AGENT_PORT = 2122
AGENT_NODE = "field_notes"
USERNAME = "Sweet-Pea-Rudi19"

NEST_PATH = Path(r"C:\Users\Sean\Willow\Nest\field_notes")

app = FastAPI(
    title="Field Notes",
    description="SAFE Field Notes Agent — captures and organizes notes, observations, and field records",
)
