"""
Private Ledger — SAFE Consumer Interface Server
================================================
Private Ledger agent FastAPI server at port 2124.
Proxies chat to Willow's agent API, journals all exchanges.
Normal users interact with Willow's system through Private Ledger — never directly.
"""
...
AGENT_PORT = 2124
AGENT_NODE = "private_ledger"
USERNAME = "Sweet-Pea-Rudi19"

NEST_PATH = Path(r"C:\Users\Sean\Willow\Nest\private_ledger")

app = FastAPI(
    title="Private Ledger",
    description="SAFE Private Ledger Agent — manages personal financial records and private transaction history",
)
